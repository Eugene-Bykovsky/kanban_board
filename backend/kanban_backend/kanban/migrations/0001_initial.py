# Generated by Django 4.2 on 2024-06-16 18:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Стек задач', 'Стек задач'), ('В процессе выполнения', 'В процессе выполнения'), ('Выполнено', 'Выполнено')], max_length=255)),
